...
public abstract class MonkeyDevice extends PyObject implements ClassDictInit {
    ...
    public void touch(PyObject[] args, String[] kws) throws IOException {
        ArgParser ap = JythonUtils.createArgParser(args, kws);
        Preconditions.checkNotNull(ap);
    ...
    public void drag(PyObject[] args, String[] kws) throws IOException {
        ArgParser ap = JythonUtils.createArgParser(args, kws);
        Preconditions.checkNotNull(ap);
    ...
    @MonkeyRunnerExported(doc = "Send a key event to the specified key",
            ...
            "send DOWN_AND_UP"})
    public void press(PyObject[] args, String[] kws) throws IOException {
        ArgParser ap = JythonUtils.createArgParser(args, kws);
        Preconditions.checkNotNull(ap);
    ...
    public void type(PyObject[] args, String[] kws) throws IOException {
        ArgParser ap = JythonUtils.createArgParser(args, kws);
        Preconditions.checkNotNull(ap);
    ...
    public String shell(PyObject[] args, String[] kws) throws Exception {
        ArgParser ap = JythonUtils.createArgParser(args, kws);
        Preconditions.checkNotNull(ap);
    ...
    public void wake(PyObject[] args, String[] kws) throws IOException {
        ArgParser ap = JythonUtils.createArgParser(args, kws);
        Preconditions.checkNotNull(ap);
    ...
    public abstract void touch(int x, int y, TouchPressType type) throws IOException;
    public abstract void press(String keyName, TouchPressType type) throws IOException;
    public abstract void drag(int startx, int starty, int endx, int endy, int steps, long ms) throws IOException;
    public abstract void type(String string) throws IOException;
    public abstract String shell(String cmd) throws Exception;
    ...
    public abstract void wake() throws IOException;
}
