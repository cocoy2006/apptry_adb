...
public class LinearInterpolator {
    ...
    public interface Callback {
         ...
         * @throws IOException 
         */
        void start(Point point) throws IOException;
        /**
         * Called once to inform of the end point.
         * @throws IOException 
         */
        void end(Point point) throws IOException;
        /**
         * Called at every step in-between start and end.
         * @throws IOException 
         */
        void step(Point point) throws IOException;
    }
     ...
     * @throws IOException 
     */
    public void interpolate(Point start, Point end, Callback callback) throws IOException {
